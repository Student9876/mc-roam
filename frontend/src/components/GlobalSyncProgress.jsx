...
export default function GlobalSyncProgress() {
  ...
  return (
    <div
      className="fixed left-0 right-0 bg-gradient-to-br from-[#1a1a1a] to-[#242424] border-t-2 border-[#4dabf7] border-b border-b-[#333] z-[9998] shadow-[0_-4px_20px_rgba(0,0,0,0.5)] animate-[slideUp_0.3s_ease-out]"
      style={{ bottom: '200px' }}
    >
      <div className="px-5 py-3 flex flex-col gap-2">
        <div className="flex items-center gap-3 font-mono text-[0.85rem]">
          ...
          <span className="text-[#69db7c] font-bold text-[0.9rem] min-w-[45px] text-right">
            {syncState.percent}%
          </span>
        </div>
        <Progress
