            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 flex-1 justify-end min-w-0">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="h-6 w-10 px-0 text-[0.6rem] shrink-0"
                  onClick={(e) => handleCopy(invite_code, e, setCopiedInvite)}
                >
                  {copiedInvite ? '\u2713' : 'Copy'}
                </Button>
              </div>
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <div className="flex items-center gap-1.5 flex-1 justify-end min-w-0">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="h-6 w-10 px-0 text-[0.6rem] shrink-0"
                    onClick={(e) => handleCopy(localAddress, e, setCopiedLocal)}
                  >
                    {copiedLocal ? '\u2713' : 'Copy'}
                  </Button>
                </div>
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <div className="flex items-center gap-1.5 flex-1 justify-end min-w-0">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-6 w-10 px-0 text-[0.6rem] shrink-0 border-[var(--color-accent-blue3)]/40 text-[var(--color-accent-blue2)]"
                    onClick={(e) => handleCopy(publicAddress, e, setCopiedPublic)}
                  >
                    {copiedPublic ? '\u2713' : 'Copy'}
                  </Button>
                </div>
